...
exports.author_list = function(req, res, next) {
    ...
    .exec(function (err, list_authors) {
        ...
        res.render('author_list', context);
    });
};
...
exports.author_detail = function(req, res) {
    async.parallel({
        ...
        if (results.author==null) { // No results.
            ...
            debug('404, Author not found error:' + err);
            err.status = 404;
            return next(err);
        }
    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            .exec( function(err, found_author) {
                ...
                } else {// Create an Author object with escaped and trimmed data.
